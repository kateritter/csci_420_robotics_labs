...
class AStarPlanner:
    ...
    def plan(self, map_data, drone_position, goal_position):
        ...
        if map_data[gi, gj] == -1:
            ...
            best_adj = min(
                adj,
                key=lambda p: abs(drone_position[0] - p[0]) + abs(drone_position[1] - p[1])
            )
    ...
    # ==================================================
    # STRICT MANHATTAN NEIGHBORS (NO DIAGONALS)
    # ==================================================
